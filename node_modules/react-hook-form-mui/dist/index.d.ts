...
declare function DatePickerElement<TFieldValues extends FieldValues>({ isDate, parseError, name, required, parseDate, validation, inputProps, control, textReadOnly, ...rest }: DatePickerElementProps<TFieldValues, any, any>): JSX.Element;
...
declare function DateTimePickerElement<TFieldValues extends FieldValues>({ isDate, parseError, name, required, parseDate, validation, inputProps, control, textReadOnly, ...rest }: DateTimePickerElementProps<TFieldValues, any, any>): JSX.Element;
